...
export default function WarehouseTransferTableRow({
  row,
  selected,
  onEditRow,
  onSelectRow,
  ...
  return (
    <>
      <TableRow hover selected={selected}>
        ...
        <TableCell align="left">{row.from_storage.name}</TableCell>
        <TableCell align="left">{row.to_storage.name}</TableCell>
